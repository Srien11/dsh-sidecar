...
.dsh-sidecar-branch-editor{display:flex;flex:1;gap:.5rem;min-width:0}.dsh-sidecar-branch-editor input{background:transparent;border:1px solid color-mix(in srgb,currentColor 15%,transparent);border-radius:.5rem;color:inherit;flex:1;min-width:0;padding:.4rem .55rem}
