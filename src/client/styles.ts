...
.dsh-sidecar-user{align-self:flex-end;background:var(--dsw-alias-state-business-tertiary)}.dsh-sidecar-assistant{align-self:flex-start;background:var(--dsw-alias-interactive-bg-hover)}
